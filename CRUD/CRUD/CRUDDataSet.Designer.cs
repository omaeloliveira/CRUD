...
namespace CRUD {
    ...
    public partial class CRUDDataSet : global::System.Data.DataSet {
        ...
        public partial class CadastroDataTable : global::System.Data.TypedTableBase<CadastroRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CadastroRow AddCadastroRow(string Nome, string Celular, string Telefone) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CadastroRow FindById_Pessoa(int Id_Pessoa) {
        ...
        public partial class CadastroRow : global::System.Data.DataRow {
            ...
            public int Id_Pessoa {
                get {
                    return ((int)(this[this.tableCadastro.Id_PessoaColumn]));
                }
                set {
                    this[this.tableCadastro.Id_PessoaColumn] = value;
                }
            }
...
namespace CRUD.CRUDDataSetTableAdapters {
    ...
    public partial class CadastroTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cadastro] WHERE (([Id_Pessoa] = @Original_Id_Pessoa) AND ([Nom" +
                "e] = @Original_Nome) AND ([Celular] = @Original_Celular) AND ((@IsNull_Telefone " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cadastro] ([Nome], [Celular], [Telefone]) VALUES (@Nome, @Celu" +
                "lar, @Telefone);\r\nSELECT Id_Pessoa, Nome, Celular, Telefone FROM Cadastro WHERE " +
                "(Id_Pessoa = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cadastro] SET [Nome] = @Nome, [Celular] = @Celular, [Telefone] = @Telefone WHERE (([Id_Pessoa] = @Original_Id_Pessoa) AND ([Nome] = @Original_Nome) AND ([Celular] = @Original_Celular) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT Id_Pessoa, Nome, Celular, Telefone FROM Cadastro WHERE (Id_Pessoa = @Id_Pessoa)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_Pessoa, Nome, Celular, Telefone FROM dbo.Cadastro";
        ...
        public virtual int Delete(int Original_Id_Pessoa, string Original_Nome, string Original_Celular, string Original_Telefone) {
        ...
        public virtual int Insert(string Nome, string Celular, string Telefone) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Celular, string Telefone, int Original_Id_Pessoa, string Original_Nome, string Original_Celular, string Original_Telefone, int Id_Pessoa) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Id_Pessoa));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Celular, string Telefone, int Original_Id_Pessoa, string Original_Nome, string Original_Celular, string Original_Telefone) {
            return this.Update(Nome, Celular, Telefone, Original_Id_Pessoa, Original_Nome, Original_Celular, Original_Telefone, Original_Id_Pessoa);
        }
    }
